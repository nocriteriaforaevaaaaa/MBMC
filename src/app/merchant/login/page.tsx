    ...
    <main className="min-h-screen bg-[#FFF5EE] text-[#3C1A0D] flex items-center justify-center px-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-[480px] relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-2xl rounded-[48px] p-10 shadow-[0_32px_64px_-16px_rgba(255,120,0,0.1)] border border-white relative overflow-hidden">
          <div className="mb-8">
            <h2 className="text-3xl font-black tracking-tight text-[#3C1A0D]">Partner Login</h2>
            <div className="h-1 w-12 bg-orange-600 mt-2 rounded-full" />
            <p className="text-xs font-medium text-[#3C1A0D]/50 mt-4">Manage your brand offers and analytics.</p>
          </div>
        ...
        <div className="mt-12 text-center space-y-6">
          <p className="text-sm font-medium text-[#3C1A0D]/50">
            ...
            <Link href="/merchant/register" className="text-orange-600 font-bold hover:underline">
              Become a Partner
            </Link>
          </p>
          <div className="h-[1px] w-12 bg-orange-200 mx-auto" />
          <Link href="/login" className="text-[10px] font-black uppercase tracking-[0.2em] text-[#3C1A0D]/30 hover:text-orange-600 transition-colors block">
